...
<div align="center">
 ...
 <a href="#-caracteristicas-do-projeto"> Características</a> • 
...
Movimentação das peças de Tetris através da inclinação da placa DE1-SoC.
Renderização gráfica do jogo Tetris em um monitor via interface VGA.
